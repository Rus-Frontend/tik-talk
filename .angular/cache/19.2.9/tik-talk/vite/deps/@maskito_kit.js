...
var ALL_POSSIBLE_SEGMENTS = ["day", "month", "year"];
...
var DEFAULT_MIN_DATE = /* @__PURE__ */ new Date("0001-01-01T00:00");
var DEFAULT_MAX_DATE = /* @__PURE__ */ new Date("9999-12-31T23:59:59.999");
...
var maskitoRejectEvent = (element) => {
  const listener = () => {
...
function maskitoParseNumber(maskedNumber, decimalSeparatorOrParams = {}) {
  const {
    decimalSeparator = ".",
    minusSign = ""
...
function createDecimalZeroPaddingPostprocessor({
  ...
  return ({
    ...
    if (Number.isNaN(maskitoParseNumber(cleanValue, {
      decimalSeparator,
      minusSign
    }))) {
      return {
...
var DEFAULT_PSEUDO_MINUSES = [CHAR_HYPHEN, CHAR_EN_DASH, CHAR_EM_DASH, CHAR_JP_HYPHEN, CHAR_MINUS];
...
//# sourceMappingURL=@maskito_kit.js.map
